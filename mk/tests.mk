# ------------------------------------------------------
# Test configuration for lib-auth
# ------------------------------------------------------
...
# PKG: specific package to test (e.g., ./auth/...)
# Usage: make test-integration RUN=TestIntegration_FeatureName
#        make test-integration PKG=./auth/...
RUN ?=
PKG ?=
...
# Supports PKG parameter to filter packages (e.g., PKG=./auth/...)
